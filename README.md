# [Now UI Kit Pro Angular](https://timcreative.github.io/now-ui-kit-pro-angular/components) [![version][version-badge]][CHANGELOG]
...
**[Now UI Kit Pro Angular](https://timcreative.github.io/now-ui-kit-pro-angular/components)** is a premium responsive Bootstrap 4 kit provided by Invision and Creative Tim. It is a beautiful cross-platform UI kit featuring over 1000+ elements and 11 templates.
...
+ [Live Preview](https://timcreative.github.io/now-ui-kit-pro-angular/components)
+ [Live Presentation Preview](https://timcreative.github.io/now-ui-kit-pro-angular/presentation)
+ [About-us Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/aboutus)
+ [Blog-post Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/blogpost)
+ [Blog-posts Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/blogposts)
+ [Contact-us Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/contactus)
+ [Landing Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/landing)
+ [Login Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/login)
+ [Pricing Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/pricing)
+ [Ecommerce Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/ecommerce)
+ [Product Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/productpage)
+ [Profile Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/profile)
+ [Signup Page](https://timcreative.github.io/now-ui-kit-pro-angular/examples/register)
...
## Terminal Commands for server side (Angular universal)
1. Install NodeJs from [NodeJs Official Page](https://nodejs.org/en).
2. Open Terminal
3. Go to your file project
4. Run in terminal: ```npm install -g @angular/cli```
...
8. Navigate to [localhost:8080](localhost:8080)
